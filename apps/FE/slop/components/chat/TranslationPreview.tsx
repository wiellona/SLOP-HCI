  ...
  return (
    <div className="retro-window">
      ...
      <div className="retro-inset" style={{ minHeight: 70, margin: 8 }}>
        {translation ? (
          <p style={{ fontFamily: 'VT323, monospace', fontSize: 22, color: '#2b1d1d', margin: 0, lineHeight: 1.3 }}>
            {translation}<span className="retro-cursor" />
          </p>
        ) : (
          <p style={{ fontFamily: 'VT323, monospace', fontSize: 18, color: '#a08060', margin: 0 }}>
            {isProcessing ? '> MEMPROSES GESTURE...' : '> MENUNGGU INPUT GESTURE...'}
        ...
        <div style={{ padding: '0 8px 8px' }}>
          <div className="retro-progress-track">
            <div
              ...
              style={{ width: '60%', animation: 'progress-anim 1.2s ease-in-out infinite alternate' }}
            />
          </div>
          <style>{`
